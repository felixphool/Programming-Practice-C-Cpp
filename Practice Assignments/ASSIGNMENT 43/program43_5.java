...
class MyArray
{
    public boolean ChkPallindrome(int arr1[], int iSize1, int arr2[], int iSize2)
    {
        ...
        {
            if(arr3[iCnt] == arr3[(arr3.length - 1) - iCnt])
            {
                bFlag = true;
            }
            else
...
class program43_5
{
    public static void main(String Arg[])
    {
        ...
        boolean bRet = obj.ChkPallindrome(arr1, iSize1, arr2 , iSize2);
